...
- 当前里程碑：TASK-001~043 已完成并归档（TASK-038 AEC 实验已回退并归档，任务卡均在 `docs/tasks/completed/`）；active：TASK-040 webui 多端历史同步（待开始）。任务卡在 `docs/tasks/active/`。最新提交与分支状态见 `git log` / `git status`。
